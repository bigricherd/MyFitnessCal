    ...
    if (props.user) {
        navbarContents = (
            <div className="navbar-nav ms-auto">
                <Link to="/sessions" className={navLinkClasses}>
                    Sessions
                </Link>
                <Link to="/forms" className={navLinkClasses}>
                    Forms
                </Link>
                <Link to="/filters" className={navLinkClasses}>
                    Filters
                </Link>
                <form
                    ...
                    method="POST"
                >
                    <button className="border-0 bg-light text-muted">
                        Logout |{" "}
